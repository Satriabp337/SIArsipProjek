    ...
    <div class="d-flex">
        <nav id="sidebar" class="bg-light border-end p-3 d-flex flex-column vh-100 position-fixed">
            ...
            <ul class="nav nav-pills flex-column">
                <li class="nav-item"><a href="/dashboard" class="nav-link text-dark"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a></li>
                ...
                <li class="nav-item"><a href="/laporan" class="nav-link text-dark"><i class="bi bi-bar-chart me-2"></i> Laporan</a></li>
                <li class="nav-item"><a href="/pengguna" class="nav-link text-dark"><i class="bi bi-people me-2"></i> Pengguna</a></li>
                <li class="nav-item"><a href="/pengaturan" class="nav-link text-dark"><i class="bi bi-gear me-2"></i> Pengaturan</a></li>
            </ul>
